...
const SEO = (props) => {
    ...
    return (
        <Head>
            ...
            <meta property="og:image" content={image ? urlForImage(image).height(256).width(256).fit('crop').url() : '/assets/images/icons/logo-full.png'} key='ogImage'/> 
            ...
            <meta name="twitter:image" content={image ? urlForImage(image).height(256).width(256).fit('crop').url() : '/assets/images/icons/logo-full.png'} key='ogTwitterImage'/> 
        </Head>
    )
